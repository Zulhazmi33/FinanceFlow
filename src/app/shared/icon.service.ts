...
export class IconService {
  private icons = [
    ...
    { name: 'build', tags: ['maintenance', 'repair', 'build'] },
    ...
    { name: 'celebration', tags: ['celebrate', 'fun', 'games', 'activity'] },
    ...
    { name: 'diamond', tags: ['jewel', 'fashion', 'wealth'] },
    ...
    { name: 'sanitizer', tags: ['soap', 'shampoo', 'toiletries', 'clean'] },
    ...
    { name: 'transit_ticket', tags: ['ticket', 'bus', 'travel'] },
